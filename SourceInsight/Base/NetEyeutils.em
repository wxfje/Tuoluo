...
macro AddFileHeader()
{
    ...
    //sz = GetFileName(GetBufName (fileNameBuf))
    //modified on 2003.12.10
    //date    = StrMid( SysTime, 6, 19 )
    year  = SysTime.Year
    month = SysTime.Month
    ...
    InsBufLine( hbuf, 1, "** COPYRIGHT (C) 2014 - 2015,sunhuaming, ShengZhen, China " )
    InsBufLine( hbuf, 2, "** FileName     :                  " )
    InsBufLine( hbuf, 3, "** Abstruct     :                  " )
    InsBufLine( hbuf, 4, "** " )
    InsBufLine( hbuf, 5, "** " )
    InsBufLine( hbuf, 6, "** Change Logs  :  " )
    InsBufLine( hbuf, 7, "** Version    Date        Author        Notes" )
    InsBufLine( hbuf, 8, "** @Version@    @year@-@month@-@day@    @szMyName@    first version" )
    InsBufLine( hbuf, 9, "** " )
    InsBufLine( hbuf, 10, "****************************************************************************/" )
